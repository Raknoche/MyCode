param_counter=1;
    ...
    %initialize matrices
a2_list=zeros(1,195858);
b2_list=zeros(1,195858);
c2_list=zeros(1,195858);
g1_list=zeros(1,195858);
g2_list=zeros(1,195858);
total_h3_chi2_list=zeros(1,195858);
total_kr_chi2_list=zeros(1,195858);
total_chi2_list=zeros(1,195858);
alternate_total_chi2_list=zeros(1,195858);
h3_chi2_2016_list=zeros(1,195858);
h3_chi2_2015_list=zeros(1,195858);
kr_chi2_2016_list=zeros(1,195858);
kr_chi2_2015_list=zeros(1,195858);
electron_lifetime_2016_list=zeros(1,195858);
electron_lifetime_2015_list=zeros(1,195858);
kr_staterr_2016_list=zeros(1,195858);
kr_staterr_2015_list=zeros(1,195858);
kr_sigma_2016_list=zeros(1,195858);
kr_sigma_2015_list=zeros(1,195858);
kr_2016_num_events=zeros(1,195858);
kr_2015_num_events=zeros(1,195858);
kr_means_2016_list=zeros(1,195858);
kr_means_2015_list=zeros(1,195858);
full_kr_chi2_2016_list=zeros(1,195858);
full_kr_chi2_2015_list=zeros(1,195858);
total_h3_chi2_nothresh_list=zeros(1,195858);
total_chi2_nothresh_list=zeros(1,195858);
alternate_total_chi2_nothresh_list=zeros(1,195858);
h3_chi2_2016_nothresh_list=zeros(1,195858);
h3_chi2_2015_nothresh_list=zeros(1,195858);
h3_chi2_2015_nothresh_separatescaling_list=zeros(1,195858);
h3_chi2_2016_nothresh_separatescaling_list=zeros(1,195858);

total_h3_chi2_nothresh_separatescaling_list=zeros(1,195858);
total_chi2_nothresh_separatescaling_list=zeros(1,195858);

h3_chi2_2016_oldsim_list=zeros(1,195858);
h3_chi2_2015_oldsim_list=zeros(1,195858);
total_h3_chi2_oldsim_list=zeros(1,195858);
total_chi2_oldsim_list=zeros(1,195858);


ee_list=zeros(1,195858);

kr_chi2_2016_zslice_list=zeros(195858,length(40+20/2:20:300-20/2));
kr_chi2_2015_zslice_list=zeros(195858,length(40+20/2:20:300-20/2));
kr_chi2_zslice_zcenter_list=zeros(195858,length(40+20/2:20:300-20/2));
%         
% total_h3_chi2_map=zeros(36,41,11,31);
% total_kr_chi2_map=zeros(36,41,11,31);
% total_chi2_map=zeros(36,41,11,31);
% alternate_total_chi2_map=zeros(36,41,11,31);
% h3_chi2_2016_map=zeros(36,41,11,31);
% kr_chi2_2016_map=zeros(36,41,11,31);
% h3_chi2_2015_map=zeros(36,41,11,31);
% kr_chi2_2015_map=zeros(36,41,11,31);
% electron_lifetime_2016_map=zeros(36,41,11,31);
% electron_lifetime_2015_map=zeros(36,41,11,31);
% total_h3_chi2_nothresh_map=zeros(36,41,11,31);
% total_chi2_nothresh_map=zeros(36,41,11,31);
% alternate_total_chi2_nothresh_map=zeros(36,41,11,31);
% h3_chi2_2016_nothresh_map=zeros(36,41,11,31);
% h3_chi2_2015_nothresh_map=zeros(36,41,11,31);
% total_h3_chi2_nothresh_separatescaling_map=zeros(36,41,11,31);
% total_chi2_nothresh_separatescaling_map=zeros(36,41,11,31);

best_total_chi2=1000000000000000000;
best_total_alternate_chi2=1000000000000000000;
best_total_chi2_nothresh=1000000000000000000;
best_total_alternate_chi2_nothresh=1000000000000000000;
best_total_chi2_nothresh_separatescaling=1000000000000000000;
best_total_chi2_oldsim=1000000000000000000;


inpaint_on=1;
% Measurement is a1=-0.765; b1=2.939; a2=0.1934; b2=-0.744;
    
load('/scratch4/UMDcode/EnergyChi2/KrypCal_2p21/TritiumMethod/libNEST_CH3TModel/NEST_CH3T_Spectrum_Sep2015_Kr2p21.mat')
load('/scratch4/UMDcode/EnergyChi2/KrypCal_2p21/TritiumMethod/libNEST_CH3TModel/NEST_CH3T_Spectrum_Feb2016_Kr2p21.mat')
load('/scratch4/UMDcode/EnergyChi2/KrypCal_2p21/TritiumMethod/libNEST_CH3TModel/NEST_CH3T_Spectrum_old.mat')


a2_counter=1;
for a2=-0.9:0.05:1; %p1*x^2 coefficient for s1ab_s2_xyz_fit.p1
    b2_counter=1;
    for b2=0:0.15:4; %p1*x^2 coefficient for s1ab_s2_xyz_fit.p1
...
s1ab_s2_xyz_fit_map.p1=a2;
s1ab_s2_xyz_fit_map.p2=b2;
c2=1-s1ab_s2_xyz_fit_map.p1.*2.7334.^2-2.7334.*s1ab_s2_xyz_fit_map.p2;
s1ab_s2_xyz_fit_map.p3=c2;


%From Matthew's S1a method - 2nd order poly
s1ab_s1_xyz_fit_map.p1=-0.0797;
s1ab_s1_xyz_fit_map.p2=0.8596;
s1ab_s1_xyz_fit_map.p3=-0.7542;%% Load the Uncorrected Sep 2015 Kr data


%HAVE TO MAKE THIS .MAT FILE STILL - USE class 1 and class 9 for S1
load('/scratch4/UMDcode/EnergyChi2/KrypCal_2p21/TritiumMethod/libNEST_CH3TModel/MappingParametersFit_Start_2015_CutDown.mat')
...
load('/scratch4/UMDcode/EnergyChi2/KrypCal_2p21/TritiumMethod/libNEST_CH3TModel/CH3T_Sep2015_NoCorrections.mat');
...
clear s1_phe_both s2_phe_both
load('/scratch4/UMDcode/EnergyChi2/KrypCal_2p21/TritiumMethod/libNEST_CH3TModel/MappingParametersFit_Start_2016_CutDown.mat')
...
clear s1_phe_both s2_phe_both
load('/scratch4/UMDcode/EnergyChi2/KrypCal_2p21/TritiumMethod/libNEST_CH3TModel/CH3T_Feb2016_NoCorrections.mat');
...
%     for g2=16.5:0.1:21;
      for ee=0.6:0.01:0.9;
         ...
         h3_energy_2016=(1/73).*(h3_s1_c_2016./g1 + h3_s2_c_2016./g2_Feb2016);
         kr_energy_2016=(1/73).*(kr_s1_c_2016./g1 + kr_s2_c_2016./g2_Feb2016);
         h3_energy_2015=(1/73).*(h3_s1_c_2015./g1 + h3_s2_c_2015./g2_sep2015);
         kr_energy_2015=(1/73).*(kr_s1_c_2015./g1 + kr_s2_c_2015./g2_sep2015);
         
         
         
        %make CH3T data spectrum
        [h3_hist_2016,h3_hist_bin_2016]=hist(h3_energy_2016,NEST_CH3T_Spectrum_Feb2016(1,:));
        [h3_hist_2015,h3_hist_bin_2015]=hist(h3_energy_2015,NEST_CH3T_Spectrum_Sep2015(1,:));
        
        %scale the simulation to the data
        scale_factor_2016=sum(h3_hist_2016)/sum(NEST_CH3T_Spectrum_Feb2016(2,:));   %sum(h3_hist_2016(17:80))./sum(NEST_CH3T_Spectrum(2,17:80)); - sims have an expected threshold now... so can ignore the bin cuts
        h3_scaled_sim_2016=scale_factor_2016.*NEST_CH3T_Spectrum_Feb2016(2,:);
        
        scale_factor_2016_nothresh=sum(h3_hist_2016(11:80))/sum(NEST_CH3T_Spectrum_Feb2016(2,11:80));   %sum(h3_hist_2016(17:80))./sum(NEST_CH3T_Spectrum(2,17:80)); - sims have an expected threshold now... so can ignore the bin cuts
        h3_scaled_sim_2016_nothresh=scale_factor_2016_nothresh.*NEST_CH3T_Spectrum_Feb2016(2,:);
                
        scale_factor_2015=sum(h3_hist_2015)/sum(NEST_CH3T_Spectrum_Sep2015(2,:)); %sum(h3_hist_2015(17:80))./sum(NEST_CH3T_Spectrum(2,17:80)); - sims have an expected threshold now... so can ignore the bin cuts
        h3_scaled_sim_2015=scale_factor_2015.*NEST_CH3T_Spectrum_Sep2015(2,:);
        
        scale_factor_2015_nothresh=sum(h3_hist_2015(11:80))/sum(NEST_CH3T_Spectrum_Sep2015(2,11:80)); %sum(h3_hist_2015(17:80))./sum(NEST_CH3T_Spectrum(2,17:80)); - sims have an expected threshold now... so can ignore the bin cuts
        h3_scaled_sim_2015_nothresh=scale_factor_2015_nothresh.*NEST_CH3T_Spectrum_Sep2015(2,:);
        ...
        h3_chi2_2016=(1/74).*sum( (h3_scaled_sim_2016(4:80) - h3_hist_2016(4:80)).^2 ./(h3_hist_2016(4:80))); %(4:80) is to avoid low stat areas in the simulation
        h3_chi2_2015=(1/74).*sum( (h3_scaled_sim_2015(4:80) - h3_hist_2015(4:80)).^2 ./(h3_hist_2015(4:80)));

        %Calculate chi2 for h3 spectrum away from threshold
        h3_chi2_2016_nothresh=(1/68).*sum( (h3_scaled_sim_2016(11:80) - h3_hist_2016(11:80)).^2 ./(h3_hist_2016(11:80))); %(4:80) is to avoid low stat areas in the simulation
        h3_chi2_2015_nothresh=(1/68).*sum( (h3_scaled_sim_2015(11:80) - h3_hist_2015(11:80)).^2 ./(h3_hist_2015(11:80)));       
        
        h3_chi2_2016_nothresh_separatescaling=(1/68).*sum( (h3_scaled_sim_2016_nothresh(11:80) - h3_hist_2016(11:80)).^2 ./(h3_hist_2016(11:80))); %(4:80) is to avoid low stat areas in the simulation
        h3_chi2_2015_nothresh_separatescaling=(1/68).*sum( (h3_scaled_sim_2015_nothresh(11:80) - h3_hist_2015(11:80)).^2 ./(h3_hist_2015(11:80)));  
        ...
        dT_step=20;
        kr_mean_2016=zeros(length(40+dT_step/2:dT_step:300-dT_step/2),1);
        ...
        full_kr_fit_res_2016=fit([0:1:1000].',hist(kr_energy_2016,[0:1:1000]).','gauss1');
        full_kr_fit_res_2015=fit([0:1:1000].',hist(kr_energy_2015,[0:1:1000]).','gauss1');
        full_kr_chi2_2016=((41.55-full_kr_fit_res_2016.b1)./0.2395).^2; %SHOULD BE 0.2395 BASED ON RUN03
        full_kr_chi2_2015=((41.55-full_kr_fit_res_2015.b1)./0.2395).^2;        
        
         clear kr_fit_res_2016 kr_fit_res_2015 kr_conf_2016 kr_conf_2015 dT_max
            kk=1;
            for dT_max=40+dT_step/2:dT_step:300-dT_step/2;
                  clear kr_fit_res_2016 kr_fit_res_2015
                  kr_fit_res_2016=fit([0:1:1000].',hist(kr_energy_2016(inrange(kr_2016_drift_time,[dT_max-dT_step dT_max])),[0:1:1000]).','gauss1');
                  kr_fit_res_2015=fit([0:1:1000].',hist(kr_energy_2015(inrange(kr_2015_drift_time,[dT_max-dT_step dT_max])),[0:1:1000]).','gauss1');     
                  kr_mean_2016(kk)=kr_fit_res_2016.b1;
            ...
            clear cut
            cut=kr_mean_2015==0 | kr_mean_2016==0;
            kr_mean_2016(cut)=[];
            kr_mean_2015(cut)=[];
            dT_centers(cut)=[];
            
    
        kr_chi2_2016=((41.55-kr_mean_2016)./0.2395).^2; %SHOULD BE 0.2395 BASED ON RUN03
        kr_chi2_2015=((41.55-kr_mean_2015)./0.2395).^2;        

        total_h3_chi2=(h3_chi2_2016+h3_chi2_2015)/2;
        total_h3_chi2_nothresh=(h3_chi2_2016_nothresh+h3_chi2_2015_nothresh)/2;
        total_h3_chi2_oldsim=(h3_chi2_2016_oldsim+h3_chi2_2015_oldsim)/2;
        total_h3_chi2_nothresh_separatescaling=(h3_chi2_2016_nothresh_separatescaling+h3_chi2_2015_nothresh_separatescaling)/2;

        total_kr_chi2_2016=mean(kr_chi2_2016);
        total_kr_chi2_2015=mean(kr_chi2_2015);
     
        total_kr_chi2=(total_kr_chi2_2016+total_kr_chi2_2015)./2;
        total_chi2=(total_kr_chi2+total_h3_chi2)/2;        
        total_chi2_nothresh=(total_kr_chi2+total_h3_chi2_nothresh)/2;        
        total_chi2_nothresh_separatescaling=(total_kr_chi2+total_h3_chi2_nothresh_separatescaling)/2;        
        total_chi2_oldsim=(total_kr_chi2+total_h3_chi2_oldsim)/2; 
        
        alternate_total_chi2=(sum( (h3_scaled_sim_2016(4:80) - h3_hist_2016(4:80)).^2 ./(h3_hist_2016(4:80)))+sum(kr_chi2_2016)+sum(kr_chi2_2015))/(74+length(kr_chi2_2016)+length(kr_chi2_2015)-4);
        alternate_total_chi2_nothresh=(sum( (h3_scaled_sim_2016(11:80) - h3_hist_2016(11:80)).^2 ./(h3_hist_2016(11:80)))+sum(kr_chi2_2016)+sum(kr_chi2_2015))/(68+length(kr_chi2_2016)+length(kr_chi2_2015)-4);
           ...
           if total_chi2_nothresh < best_total_chi2_nothresh;
            best_total_chi2_nothresh=total_chi2_nothresh;
            best_total_kr_chi2_nothresh=total_kr_chi2;
            best_total_h3_chi2_nothresh=total_h3_chi2_nothresh;
            besta2_nothresh=a2;
            bestb2_nothresh=b2;
            bestc2_nothresh=c2;    
            bestg1_nothresh=g1;
           ...
           if total_chi2_nothresh_separatescaling < best_total_chi2_nothresh_separatescaling;
            best_total_chi2_nothresh_separatescaling=total_chi2_nothresh_separatescaling;
            best_total_kr_chi2_nothresh_separatescaling=total_kr_chi2;
            best_total_h3_chi2_nothresh_separatescaling=total_h3_chi2_nothresh_separatescaling;
            besta2_nothresh_separatescaling=a2;
            bestb2_nothresh_separatescaling=b2;
            bestc2_nothresh_separatescaling=c2;    
            bestg1_nothresh_separatescaling=g1;
            bestEE_nothresh_separatescaling=ee;
           end

            if alternate_total_chi2_nothresh < best_total_alternate_chi2_nothresh;
            best_total_alternate_chi2_nothresh=alternate_total_chi2_nothresh;
            best_total_alternate_kr_chi2_nothresh=total_kr_chi2;
            best_total_alternate_h3_chi2_nothresh=total_h3_chi2_nothresh;
            besta2_alternate_nothresh=a2;
            bestb2_alternate_nothresh=b2;
            bestc2_alternate_nothresh=c2;    
            bestg1_alternate_nothresh=g1;
            bestEE_alternate_nothresh=ee;
           end             
            
            if total_chi2_oldsim < best_total_chi2_oldsim;
            best_total_chi2_oldsim=total_chi2_oldsim;
            best_total_kr_chi2_oldsim=total_kr_chi2;
            best_total_h3_chi2_oldsim=total_h3_chi2_oldsim;
            besta2_oldsim=a2;
            bestb2_oldsim=b2;
            bestc2_oldsim=c2;    
            bestg1_oldsim=g1;
...
ee_list(param_counter)=ee;
total_h3_chi2_list(param_counter)=total_h3_chi2;
total_h3_chi2_nothresh_list(param_counter)=total_h3_chi2_nothresh;
total_kr_chi2_list(param_counter)=total_kr_chi2;
total_chi2_list(param_counter)=total_chi2;
total_chi2_nothresh_list(param_counter)=total_chi2_nothresh;
alternate_total_chi2_list(param_counter)=alternate_total_chi2;
alternate_total_chi2_nothresh_list(param_counter)=alternate_total_chi2_nothresh;

total_h3_chi2_nothresh_separatescaling_list(param_counter)=total_h3_chi2_nothresh_separatescaling;
total_chi2_nothresh_separatescaling_list(param_counter)=total_chi2_nothresh_separatescaling;

h3_chi2_2016_list(param_counter)=h3_chi2_2016;
h3_chi2_2016_nothresh_list(param_counter)=h3_chi2_2016_nothresh;
h3_chi2_2015_list(param_counter)=h3_chi2_2015;
h3_chi2_2015_nothresh_list(param_counter)=h3_chi2_2015_nothresh;
h3_chi2_2015_nothresh_separatescaling_list(param_counter)=h3_chi2_2015_nothresh_separatescaling;
h3_chi2_2016_nothresh_separatescaling_list(param_counter)=h3_chi2_2016_nothresh_separatescaling;

kr_chi2_2016_list(param_counter)=total_kr_chi2_2016;
kr_chi2_2015_list(param_counter)=total_kr_chi2_2015;
full_kr_chi2_2016_list(param_counter)=full_kr_chi2_2016;
full_kr_chi2_2015_list(param_counter)=full_kr_chi2_2015;
electron_lifetime_2016_list(param_counter)=pseudo_lifetime_2016;
electron_lifetime_2015_list(param_counter)=pseudo_lifetime_2015;

kr_chi2_2016_zslice_list(param_counter,:)=kr_chi2_2016;
kr_chi2_2015_zslice_list(param_counter,:)=kr_chi2_2015;
kr_chi2_zslice_zcenter_list(param_counter,:)=dT_centers;

h3_chi2_2016_oldsim_list(param_counter)=h3_chi2_2016_oldsim;
h3_chi2_2015_oldsim_list(param_counter)=h3_chi2_2015_oldsim;
total_h3_chi2_oldsim_list(param_counter)=total_h3_chi2_oldsim;
total_chi2_oldsim_list(param_counter)=total_chi2_oldsim;

% total_h3_chi2_map(a2_counter,b2_counter,g1_counter,g2_counter)=total_h3_chi2;
% total_h3_chi2_nothresh_map(a2_counter,b2_counter,g1_counter,g2_counter)=total_h3_chi2_nothresh;
...
% total_chi2_nothresh_map(a2_counter,b2_counter,g1_counter,g2_counter)=total_chi2_nothresh;
% alternate_total_chi2_map(a2_counter,b2_counter,g1_counter,g2_counter)=alternate_total_chi2;
% alternate_total_chi2_nothresh_map(a2_counter,b2_counter,g1_counter,g2_counter)=alternate_total_chi2_nothresh;
% h3_chi2_2016_map(a2_counter,b2_counter,g1_counter,g2_counter)=h3_chi2_2016;
% h3_chi2_2016_nothresh_map(a2_counter,b2_counter,g1_counter,g2_counter)=h3_chi2_2016_nothresh;
% kr_chi2_2016_map(a2_counter,b2_counter,g1_counter,g2_counter)=total_kr_chi2_2016;
% h3_chi2_2015_map(a2_counter,b2_counter,g1_counter,g2_counter)=h3_chi2_2015;
% h3_chi2_2015_nothresh_map(a2_counter,b2_counter,g1_counter,g2_counter)=h3_chi2_2015_nothresh;
% kr_chi2_2015_map(a2_counter,b2_counter,g1_counter,g2_counter)=total_kr_chi2_2015;
% electron_lifetime_2016_map(a2_counter,b2_counter,g1_counter,g2_counter)=pseudo_lifetime_2016;
% electron_lifetime_2015_map(a2_counter,b2_counter,g1_counter,g2_counter)=pseudo_lifetime_2015;
% 
% total_h3_chi2_nothresh_separatescaling_map(a2_counter,b2_counter,g1_counter,g2_counter)=total_h3_chi2_nothresh_separatescaling;
% total_chi2_nothresh_separatescaling_map(a2_counter,b2_counter,g1_counter,g2_counter)=total_chi2_nothresh_separatescaling;
...
h3_chi2_2016_list(param_counter)=-1;
h3_chi2_2015_list(param_counter)=-1;
kr_chi2_2016_list(param_counter)=-1;
kr_chi2_2015_list(param_counter)=-1;
electron_lifetime_2016_list(param_counter)=-1;
electron_lifetime_2015_list(param_counter)=-1;
full_kr_chi2_2016_list(param_counter)=-1;
full_kr_chi2_2015_list(param_counter)=-1;
kr_chi2_2016_zslice_list(param_counter,:)=-1;
kr_chi2_2015_zslice_list(param_counter,:)=-1;
kr_chi2_zslice_zcenter_list(param_counter,:)=-1;
total_h3_chi2_nothresh_list(param_counter)=-1;
total_chi2_nothresh_list(param_counter)=-1;
alternate_total_chi2_nothresh_list(param_counter)=-1;
h3_chi2_2015_nothresh_list(param_counter)=-1;
h3_chi2_2016_nothresh_list(param_counter)=-1;
h3_chi2_2015_nothresh_separatescaling_list(param_counter)=-1;
h3_chi2_2016_nothresh_separatescaling_list(param_counter)=-1;

total_h3_chi2_nothresh_separatescaling_list(param_counter)=-1;
total_chi2_nothresh_separatescaling_list(param_counter)=-1;


h3_chi2_2016_oldsim_list(param_counter)=-1;
h3_chi2_2015_oldsim_list(param_counter)=-1;
total_h3_chi2_oldsim_list(param_counter)=-1;
total_chi2_oldsim_list(param_counter)=-1;
...
% h3_chi2_2016_map(a2_counter,b2_counter,:,:)=-1;
% kr_chi2_2016_map(a2_counter,b2_counter,:,:)=-1;
% h3_chi2_2015_map(a2_counter,b2_counter,:,:)=-1;
% kr_chi2_2015_map(a2_counter,b2_counter,:,:)=-1;
% electron_lifetime_2016_map(a2_counter,b2_counter,:,:)=-1;
% electron_lifetime_2015_map(a2_counter,b2_counter,:,:)=-1;
% total_h3_chi2_nothresh_map(a2_counter,b2_counter,:,:)=-1;
% total_chi2_nothresh_map(a2_counter,b2_counter,:,:)=-1;
% alternate_total_chi2_nothresh_map(a2_counter,b2_counter,:,:)=-1;
% h3_chi2_2016_nothresh_map(a2_counter,b2_counter,:,:)=-1;
% h3_chi2_2015_nothresh_map(a2_counter,b2_counter,:,:)=-1;
% 
% total_h3_chi2_nothresh_separatescaling_map(a2_counter,b2_counter,:,:)=-1;
% total_chi2_nothresh_separatescaling_map(a2_counter,b2_counter,:,:)=-1;
...
clearvars -except param_counter a1_list b1_list a2_list b2_list total_chi2_list h3_chi2_list kr_chi2_list g1_list g2_list total_chi2_map h3_chi2_map kr_chi2_map chi2_midtobot_list...
    ...
    firsta1 firstb1 firsta2 firstb2 firstg1 firstg2 kr_means_2015_map kr_means_2016_map kr_sigma_2015_map kr_sigma_2016_map kr_staterr_2015_map kr_staterr_2016_map ...
    kr_means_2015_list kr_means_2016_list kr_2015_num_events kr_2016_num_events kr_sigma_2015_list kr_sigma_2016_list kr_staterr_2015_list kr_staterr_2016_list ...
    pseudo_lifetime_2016 pseudo_lifetime_2015 kr_2015_drift_time kr_2015_s2x kr_2015_s2y  kr_2016_drift_time kr_2016_s2x kr_2016_s2y ...
    kr_chi2_2016_zslice_list kr_chi2_2015_zslice_list kr_chi2_zslice_zcenter_list ...
    full_kr_chi2_2016_list full_kr_chi2_2015_list best_total_kr_chi2 best_total_h3_chi2 alternate_total_chi2_map alternate_total_chi2_list ...
    best_total_alternate_chi2 best_total_alternate_kr_chi2 best_total_alternate_h3_chi2 besta2_alternate bestb2_alternate bestg1_alternate bestg2_alternate bestc2_alternate c2 ...
    total_h3_chi2_nothresh_list total_chi2_nothresh_list alternate_total_chi2_nothresh_list h3_chi2_2015_nothresh_list h3_chi2_2016_nothresh_list ...
...
save('/scratch4/UMDcode/EnergyChi2/KrypCal_2p21/S1aMethod/libNEST_CH3TModel/S1aS1bParamScan_EnergyChi2_S1aMethod_newrange2.mat') 
