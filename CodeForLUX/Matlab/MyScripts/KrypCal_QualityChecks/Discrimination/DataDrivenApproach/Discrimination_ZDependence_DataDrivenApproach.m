...
%             temporary, for calculating correct E-lifetime   
            clear mean_ER_band_err lower_bound_err upper_bound_err lower_bound mean_ER_band upper_bound  ...
             ...
             NR_mean_data=NR_mean_fit_points{bin_counter};
             NR_mean_data_err=NR_mean_fit_points_err{bin_counter};
...
%  ylim([0 3.5]);xlim([0 s1_max]);
        ...
        for i=1:length(counting_leakage_frac_tracker)
         errorbar(NR_bins_tracked{i},counting_leakage_frac_tracker{i},counting_leakage_frac_err_tracker{i},'Color',colors{i})
        end
...
%  ylim([0 3.5]);xlim([0 s1_max]);
        ...
        for i=1:length(counting_leakage_frac_tracker)
         errorbar(NR_bins_tracked{i},gaussian_leakage_frac_tracker{i},gaussian_leakage_frac_err_tracker{i},'Color',colors{i})
        end   
