...
pulse_area_cut= (log10(s1_phe_both_xyz)+0.7*log10(s2_phe_both_xyz)<5) & (log10(s1_phe_both_xyz)+0.7*log10(s2_phe_both_xyz)>2) & ...
    (log10(s1_phe_both_xyz)-2*log10(s2_phe_both_xyz)<-5) & (log10(s1_phe_both_xyz)-2*log10(s2_phe_both_xyz)>-7.3);
...
%             temporary, for calculating correct E-lifetime   
 ...
 save('ERBand_Z_Dep_NoFieldCorr','ER_bins','ER_lower_fit','ER_mean_fit','ER_upper_fit');
