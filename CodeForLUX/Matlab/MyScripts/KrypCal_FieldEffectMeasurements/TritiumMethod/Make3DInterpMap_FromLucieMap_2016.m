load('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\KrypCal_RD\KrypCal_2p21\TritiumMethod\LucieFeb2016_Map_v1p0.mat');
x= LucieFeb2016_Map_v1p0(:,1);
y= LucieFeb2016_Map_v1p0(:,2);
z = LucieFeb2016_Map_v1p0(:,3);
field = LucieFeb2016_Map_v1p0(:,4);
...
save('Feb2016_3DFieldMap_ForPython_v1p0','DriftTimeMap','FieldMap','x_bins','y_bins','z_bins');
% save('Feb2016_XYZ_to_XYdT_Map_Python','FieldMap','x_bins','y_bins','z_bins');
