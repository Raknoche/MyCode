param_counter=1;
    ...
    %initialize matrices
a2_list=zeros(1,503316);
b2_list=zeros(1,503316);
c2_list=zeros(1,503316);
g1_list=zeros(1,503316);
g2_list=zeros(1,503316);
total_h3_chi2_list=zeros(1,503316);
total_kr_chi2_list=zeros(1,503316);
total_chi2_list=zeros(1,503316);
alternate_total_chi2_list=zeros(1,503316);
h3_chi2_2016_list=zeros(1,503316);
h3_chi2_2015_list=zeros(1,503316);
kr_chi2_2016_list=zeros(1,503316);
kr_chi2_2015_list=zeros(1,503316);
electron_lifetime_2016_list=zeros(1,503316);
electron_lifetime_2015_list=zeros(1,503316);
kr_staterr_2016_list=zeros(1,503316);
kr_staterr_2015_list=zeros(1,503316);
kr_sigma_2016_list=zeros(1,503316);
kr_sigma_2015_list=zeros(1,503316);
kr_2016_num_events=zeros(1,503316);
kr_2015_num_events=zeros(1,503316);
kr_means_2016_list=zeros(1,503316);
kr_means_2015_list=zeros(1,503316);
full_kr_chi2_2016_list=zeros(1,503316);
full_kr_chi2_2015_list=zeros(1,503316);
total_h3_chi2_nothresh_list=zeros(1,503316);
total_chi2_nothresh_list=zeros(1,503316);
alternate_total_chi2_nothresh_list=zeros(1,503316);
h3_chi2_2016_nothresh_list=zeros(1,503316);
h3_chi2_2015_nothresh_list=zeros(1,503316);
h3_chi2_2015_nothresh_separatescaling_list=zeros(1,503316);
h3_chi2_2016_nothresh_separatescaling_list=zeros(1,503316);

total_h3_chi2_nothresh_separatescaling_list=zeros(1,503316);
total_chi2_nothresh_separatescaling_list=zeros(1,503316);

h3_chi2_2016_oldsim_list=zeros(1,503316);
h3_chi2_2015_oldsim_list=zeros(1,503316);
total_h3_chi2_oldsim_list=zeros(1,503316);
total_chi2_oldsim_list=zeros(1,503316);


ee_list=zeros(1,503316);

kr_chi2_2016_zslice_list=zeros(503316,length(40+20/2:20:300-20/2));
kr_chi2_2015_zslice_list=zeros(503316,length(40+20/2:20:300-20/2));
kr_chi2_zslice_zcenter_list=zeros(503316,length(40+20/2:20:300-20/2));
%         
...
a2_counter=1;
for a2=0:0.02:0.7; %p1*x^2 coefficient for s1ab_s2_xyz_fit.p1
    b2_counter=1;
    for b2=0:0.05:2; %p1*x^2 coefficient for s1ab_s2_xyz_fit.p1
...
s1ab_s2_xyz_fit_map.p1=-0.4988; %these are slightly different than Kr2p20, prob just a resulting of the fitting
...
save('/scratch4/UMDcode/EnergyChi2/KrypCal_2p21/TritiumMethod/libNEST_CH3TModel/S1aS1bParamScan_EnergyChi2_S1FloatPoly_S2Poly2015_Improved_Wtih1D2D.mat') 
