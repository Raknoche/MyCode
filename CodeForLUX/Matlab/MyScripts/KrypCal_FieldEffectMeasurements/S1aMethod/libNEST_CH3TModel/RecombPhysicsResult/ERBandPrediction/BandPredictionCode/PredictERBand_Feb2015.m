...
load('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\KrypCal_RD\KrypCal_2p21\S1aMethod\libNEST_CH3TModel\RecombPhysicsResult\ERBandPrediction\Feb2015_S1aS1b.mat')
    ...
    for j=1:size(s1ab_xyz_mean,2)
        ...
        %Make MCMC of predicted band for the voxel
                for counter=1:Kr_count_3D(i,j,k)/10;
                     ...
                     yy= log10((10.^(powerlaw_a.*xx.^powerlaw_b)).*(SE_size_Feb2015/SE_size_Sep2015)); %Get associate log10(S1/S2) mean from power law fit
                     yy_sigma=abs(yy-log10((10.^(powerlaw_a_upper.*xx.^powerlaw_b_upper)).*(SE_size_Feb2015/SE_size_Sep2015)) )/1.28; %Get associate log10(S1/S2) gaussian width from power law fit
...
load('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\KrypCal_RD\KrypCal_2p21\S1aMethod\libNEST_CH3TModel\RecombPhysicsResult\ERBandPrediction\Feb2015_ERFit.mat')
