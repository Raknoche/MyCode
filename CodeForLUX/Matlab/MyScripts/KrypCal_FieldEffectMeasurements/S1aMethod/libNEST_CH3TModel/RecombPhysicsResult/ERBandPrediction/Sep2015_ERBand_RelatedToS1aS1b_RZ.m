...
fiducial_cut=inrange(s2radius.^2,[r2_max-s1ab_r2_binsize,r2_max]) & inrange(drift_time,[z_max-s1ab_z_binsize z_max]);  
...
temp_mean_s1as1b_map=s1ab_r2z_mean(:);
temp_mean_s1as1b_map_totalerr=s1ab_r2z_mean_err(:);
...
save('S1aS1b_To_ERBand_RZVoxels','S1aS1b_to_mean_a_fit','S1aS1b_to_mean_b_fit','S1aS1b_to_lower_a_fit','S1aS1b_to_lower_b_fit','S1aS1b_to_upper_a_fit','S1aS1b_to_upper_b_fit',...
