...
%
%  Purpose: 
%       This script compares Kr S1a/S1b data to Scott's field simulations in Sep2014 so that
...
%Hardcoding inputs for ease of use
...
%     
    ...
    x=[0:0.1:3];
    y=polyval(S1aS1b_fit_2014,x);
    plot(x,y,'-k')

%% saving
save('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\KrypCal\KrypCal_2p20_Code\2014_Field_to_S1aS1b','S1aS1b_fit_2014','S1aS1b_fit_2014_error');
