...
load('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\KrypCal_RD\KrypCal_2p21\KrypCal2p21_QualityChecks\EnergyResolution\MappingParametersFit_Start_Oct2015DD_CutDown');
...
Xe129_40keV_mean=fit_40kev.b1
Xe129_40keV_sig=fit_40kev.c1/sqrt(2)
temp=confint(fit_40kev,0.68);
Xe129_40keV_mean_err=abs(fit_40kev.b1-temp(1,2))
Xe129_40keV_sig_err=abs(fit_40kev.c1-temp(1,3))/sqrt(2)
Xe129_40keV_resolution=(fit_40kev.c1/sqrt(2))/fit_40kev.b1
Xe129_40keV_resolution_err=sqrt ( (Xe129_40keV_sig_err./Xe129_40keV_mean).^2 + ( (Xe129_40keV_sig.*Xe129_40keV_mean_err)./(Xe129_40keV_mean.^2)).^2 )

Xe131_80keV_mean=fit_80kev.b1
Xe131_80keV_sig=fit_80kev.c1/sqrt(2)
temp=confint(fit_80kev,0.68);
Xe131_80keV_mean_err=abs(fit_80kev.b1-temp(1,2))
Xe131_80keV_sig_err=abs(fit_80kev.c1-temp(1,3))/sqrt(2)
Xe131_80keV_resolution=(fit_80kev.c1/sqrt(2))/fit_80kev.b1
Xe131_80keV_resolution_err=sqrt ( (Xe131_80keV_sig_err./Xe131_80keV_mean).^2 + ( (Xe131_80keV_sig.*Xe131_80keV_mean_err)./(Xe131_80keV_mean.^2)).^2 )

Xe131_164keV_mean=fit_164kev.b1
Xe131_164keV_sig=fit_164kev.c1/sqrt(2)
temp=confint(fit_164kev,0.68);
Xe131_164keV_mean_err=abs(fit_164kev.b1-temp(1,2))
Xe131_164keV_sig_err=abs(fit_164kev.c1-temp(1,3))/sqrt(2)
Xe131_164keV_resolution=(fit_164kev.c1/sqrt(2))/fit_164kev.b1
Xe131_164keV_resolution_err=sqrt ( (Xe131_164keV_sig_err./Xe131_164keV_mean).^2 + ( (Xe131_164keV_sig.*Xe131_164keV_mean_err)./(Xe131_164keV_mean.^2)).^2 )

Xe129_236keV_mean=fit_236kev.b1
Xe129_236keV_sig=fit_236kev.c1/sqrt(2)
temp=confint(fit_236kev,0.68);
Xe129_236keV_mean_err=abs(fit_236kev.b1-temp(1,2))
Xe129_236keV_sig_err=abs(fit_236kev.c1-temp(1,3))/sqrt(2)
Xe129_236keV_resolution=(fit_236kev.c1/sqrt(2))/fit_236kev.b1
Xe129_236keV_resolution_err=sqrt ( (Xe129_236keV_sig_err./Xe129_236keV_mean).^2 + ( (Xe129_236keV_sig.*Xe129_236keV_mean_err)./(Xe129_236keV_mean.^2)).^2 )

Xe125_275keV_mean=fit_275kev.b1
Xe125_275keV_sig=fit_275kev.c1/sqrt(2)
temp=confint(fit_275kev,0.68);
Xe125_275keV_mean_err=abs(fit_275kev.b1-temp(1,2))
Xe125_275keV_sig_err=abs(fit_275kev.c1-temp(1,3))/sqrt(2)
Xe125_275keV_resolution=(fit_275kev.c1/sqrt(2))/fit_275kev.b1
Xe125_275keV_resolution_err=sqrt ( (Xe125_275keV_sig_err./Xe125_275keV_mean).^2 + ( (Xe125_275keV_sig.*Xe125_275keV_mean_err)./(Xe125_275keV_mean.^2)).^2 )
