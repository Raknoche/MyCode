% load('C:\Program Files\MATLAB\R2012a\bin\Run04_ERBand\Kr2p14_FixedZHisto\S1aS1bParamScan_BothPolyFloat_FixedZHisto_FourParam_FineRes_test.mat') 
             
s1ab_s2_xyz_fit_map.p1=-0.5448;
s1ab_s2_xyz_fit_map.p2=1.7272;
c1=1-s1ab_s2_xyz_fit_map.p1.*2.7313.^2-2.7313.*s1ab_s2_xyz_fit_map.p2;
...
kr_2015_s2y=S2_y(kr_cut);
 ...
 clearvars -except param_counter a1_list b1_list a2_list b2_list total_chi2_list h3_chi2_list kr_chi2_list g1_list g2_list total_chi2_map h3_chi2_map kr_chi2_map chi2_midtobot_list...
    ...
    full_kr_chi2_2014_list full_kr_chi2_2015_list best_total_kr_chi2 best_total_h3_chi2
...
load('C:\Program Files\MATLAB\R2012a\bin\Run04_ERBand\Kr2p20\NEST_CH3T_Spectrum_Sep2014_Kr2p20.mat')
load('C:\Program Files\MATLAB\R2012a\bin\Run04_ERBand\Kr2p20\NEST_CH3T_Spectrum_Sep2015_Kr2p20.mat')


best_total_chi2=100000000;
for g1=0.09:0.005:0.125;
    for ee=0.55:0.01:1.0;
...
Kr_E_2014=(1/73).*(kr_s1_c_2014./g1+kr_s2_c_2014./g2_sep2014);
H3_E_2014=(1/73).*(h3_s1_c_2014./g1+h3_s2_c_2014./g2_sep2014);
...
for dT_max=40+20/2:20:300-20/2;
    temp_fit_2014=fit([0:1:100].',hist(Kr_E_2014(inrange(kr_2014_drift_time,[dT_max-20 dT_max])),[0:1:100]).','gauss1');
    kr_2014_means(i)=temp_fit_2014.b1;
    kr_2014_means_err(i)=temp_fit_2014.c1/sqrt(2)/length(Kr_E_2014(inrange(kr_2014_drift_time,[dT_max-20 dT_max])));
...
kr_2014_chi2_slices=((41.55-kr_2014_means)./0.2395).^2;
kr_2015_chi2_slices=((41.55-kr_2015_means)./0.2395).^2;

% figure
% errorbar(dT_centers,kr_2014_means,kr_2014_means_err,'.k');
% xlabel('Drift Time (uSec)'); ylabel('Kr Energy Mean (phd)');
% title('2014 Data');
% myfigview(16);
% 
% figure
% errorbar(dT_centers,kr_2015_means,kr_2015_means_err,'.k');
% xlabel('Drift Time (uSec)'); ylabel('Kr Energy Mean (phd)');
% title('2015 Data');
% myfigview(16);
% 
...
% myfigview(16);
     ...
     %make CH3T data spectrum
        [h3_hist_sep2014,h3_hist_bin_sep2014]=hist(H3_E_2014,NEST_CH3T_Spectrum_Sep2014(1,:));
        [h3_hist_sep2015,h3_hist_bin_sep2015]=hist(H3_E_2015,NEST_CH3T_Spectrum_Sep2015(1,:));
        
        %scale the simulation to the data
        scale_factor_sep2014=sum(h3_hist_sep2014)./sum(NEST_CH3T_Spectrum_Sep2014(2,:));
        scale_factor_sep2015=sum(h3_hist_sep2015)./sum(NEST_CH3T_Spectrum_Sep2015(2,:));
        h3_scaled_sim_sep2014=NEST_CH3T_Spectrum_Sep2014(2,:).*scale_factor_sep2014;
        h3_scaled_sim_sep2015=NEST_CH3T_Spectrum_Sep2015(2,:).*scale_factor_sep2015;
            
                h3_chi2_Sep2014=(1/63).*sum( (h3_scaled_sim_sep2014(15:80) - h3_hist_sep2014(15:80)).^2 ./(h3_hist_sep2014(15:80)));
                h3_chi2_Sep2015=(1/63).*sum( (h3_scaled_sim_sep2015(15:80) - h3_hist_sep2015(15:80)).^2 ./(h3_hist_sep2015(15:80)));

                
                total_h3_chi2=(h3_chi2_Sep2014+h3_chi2_Sep2015)/2;
                total_kr_chi2=(mean(kr_2014_chi2_slices)+mean(kr_2015_chi2_slices))/2;
...
figure
step(Kr_E_2014,[30:0.5:60],'r')
hold on;
step(Kr_E_2015,[30:0.5:60],'b',length(Kr_E_2014)./length(Kr_E_2015))
line([41.55 41.55],[0 30000],'Color','k','LineWidth',2)
xlabel('Energy (keV)'); ylabel('Counts'); myfigview(16); 
legend('2014','2015','Expected');

krfit_2014=fit([30:0.5:60].',hist(Kr_E_2014,[30:0.5:60]).','gauss1');
krerr_2014=confint(krfit_2014,0.68);
x=[30:0.5:60];
y=krfit_2014.a1.*exp(-((x-krfit_2014.b1)./krfit_2014.c1).^2);
hold on;
plot(x,y,'-r');

kr_mean_2014=krfit_2014.b1
kr_sig=krfit_2014.c1/sqrt(2)
kr_mean_err_2014=abs(krfit_2014.b1-krerr_2014(1,2)) %kr_sig./sqrt(length(Kr_E_2014(inrange(Kr_E_2014,[30 60])))) %  
kr_sig_err=abs(krfit_2014.c1-krerr_2014(1,3))/sqrt(2)

krfit_2015=fit([30:0.5:60].',(length(Kr_E_2014)./length(Kr_E_2015)).*hist(Kr_E_2015,[30:0.5:60]).','gauss1');
...
figure
step(H3_E_2014,[0:0.25:22],'-r')
hold on;
plot(NEST_CH3T_Spectrum_Sep2014(1,:),h3_scaled_sim_sep2014,'-k','LineWidth',2)
xlabel('Energy (keV)'); ylabel('Counts'); myfigview(16); 
legend('Sep2014 Data','Expected');

figure
step(H3_E_2015,[0:0.25:22],'-r')
hold on;
plot(NEST_CH3T_Spectrum_Sep2015(1,:),h3_scaled_sim_sep2015,'-k','LineWidth',2)
xlabel('Energy (keV)'); ylabel('Counts'); myfigview(16); 
legend('Sep2015 Data','Expected');


% kr_2015_chi2_total=((41.55-krfit_2015.b1)./0.2395).^2;
% kr_2014_chi2_total=((41.55-krfit_2014.b1)./0.2395).^2;
% 
% 
% fid=fopen('Run04_Kr2p14_CH3TData_2014EnergyChi2Prelim.txt','w');
% for i=1:length(h3_s1_c_2014)
%     fprintf(fid,'%d %d \n', h3_s1_c_2014(i), h3_s2_c_2014(i));
% end
% 
% 
% fid=fopen('Run04_Kr2p14_CH3TData_2015EnergyChi2Prelim.txt','w');
% for i=1:length(h3_s1_c_2014)
%     fprintf(fid,'%d %d \n', h3_s1_c_2015(i), h3_s2_c_2015(i));
% end