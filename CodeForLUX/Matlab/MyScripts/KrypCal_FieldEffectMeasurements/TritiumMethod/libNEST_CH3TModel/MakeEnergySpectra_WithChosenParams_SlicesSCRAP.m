...
% s1ab_s2_xyz_fit_map.p1=-0.4988; %these are slightly different than Kr2p21, prob just a resulting of the fitting
% s1ab_s2_xyz_fit_map.p2=1.484;
% c1=1-s1ab_s2_xyz_fit_map.p1.*2.7303.^2-2.7303.*s1ab_s2_xyz_fit_map.p2;
% s1ab_s2_xyz_fit_map.p3=c1;
% 
% s1ab_s1_xyz_fit_map.p1=0.0400;
% s1ab_s1_xyz_fit_map.p2= 0.4000;
% s1ab_s1_xyz_fit_map.p3=-0.3903;
...
s1ab_s1_xyz_fit_map.p2=0.35;
s1ab_s1_xyz_fit_map.p3=0.0444;
...
kr_2015_s2y=S2_y(kr_cut);
 ...
 clearvars -except param_counter a1_list b1_list a2_list b2_list total_chi2_list h3_chi2_list kr_chi2_list g1_list g2_list total_chi2_map h3_chi2_map kr_chi2_map chi2_midtobot_list...
    ...
    kr_chi2_2016_map kr_chi2_2015_map electron_lifetime_2016_map electron_lifetime_2015_map NEST_CH3T_Spectrum g1 g2 bestg1 bestg2 g1_counter g2_counter ...
    ...
    full_kr_chi2_2016_list full_kr_chi2_2015_list best_total_kr_chi2 best_total_h3_chi2
...
clear s1_phe_both s2_phe_both
load('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\KrypCal_RD\KrypCal_2p21\CH3T_Feb2016_NoCorrections.mat');
...
s1_max=120;
  ...
  %% Redo with r<10 cm
    ...
    liquid_cut= clean_cut & inrange(drift_time,[40 300]) & inrange(s1_phe_both_xyz,[s1_min s1_max]) ...
...
kr_sig_err=abs(krfit_2015.c1-krerr_2015(1,3))/sqrt(2)
     ...
     %make CH3T data spectrum
        [h3_hist_Feb2016,h3_hist_bin_Feb2016]=hist(H3_E_2016,NEST_CH3T_Spectrum_Feb2016(1,:));
        [h3_hist_sep2015,h3_hist_bin_sep2015]=hist(H3_E_2015,NEST_CH3T_Spectrum_Sep2015(1,:));
        %scale the simulation to the data
        scale_factor_Feb2016=sum(h3_hist_Feb2016(11:80))./sum(NEST_CH3T_Spectrum_Feb2016(2,11:80));
        scale_factor_sep2015=sum(h3_hist_sep2015(11:80))./sum(NEST_CH3T_Spectrum_Sep2015(2,11:80));
        h3_scaled_sim_Feb2016=NEST_CH3T_Spectrum_Feb2016(2,:).*scale_factor_Feb2016;
        h3_scaled_sim_sep2015=NEST_CH3T_Spectrum_Sep2015(2,:).*scale_factor_sep2015;


figure
step(H3_E_2016,NEST_CH3T_Spectrum_Feb2016(1,:),'-r')
hold on;
plot(NEST_CH3T_Spectrum_Feb2016(1,:),h3_scaled_sim_Feb2016,'-k','LineWidth',2)
xlabel('Energy (keV)'); ylabel('Counts'); myfigview(16); 
legend('Feb2016 Data','Expected');

figure
step(H3_E_2015,NEST_CH3T_Spectrum_Feb2016(1,:),'-r')
hold on;
