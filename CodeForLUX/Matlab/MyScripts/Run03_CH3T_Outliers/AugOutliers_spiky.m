load('C:\Program Files\MATLAB\R2012a\bin\Run03_CH3T_Outliers\Run03_Aug_Golden_CH3T.mat')
...
%     & (log10(s1area)+0.5*log10(s2area)<3.8) & s2_phe_both>100 ; %used to be drift time 100 to 250
    ...
    band_sigma=3.5; %3.5 sigma = 1 in 4,000 chance of being outside this
...
hold on;
scatter(x_corr(above_band_cut),y_corr(above_band_cut),'.r')
circle(0,0,25);
legend('Below Band','Above Band','R=25cm');
