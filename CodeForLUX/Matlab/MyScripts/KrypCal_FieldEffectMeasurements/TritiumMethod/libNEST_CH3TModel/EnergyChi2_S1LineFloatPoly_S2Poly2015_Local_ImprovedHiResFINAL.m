param_counter=1;
    ...
    %initialize matrices
a2_list=zeros(1,722150);
b2_list=zeros(1,722150);
c2_list=zeros(1,722150);
g1_list=zeros(1,722150);
g2_list=zeros(1,722150);
total_h3_chi2_list=zeros(1,722150);
total_kr_chi2_list=zeros(1,722150);
total_chi2_list=zeros(1,722150);
alternate_total_chi2_list=zeros(1,722150);
h3_chi2_2016_list=zeros(1,722150);
h3_chi2_2015_list=zeros(1,722150);
kr_chi2_2016_list=zeros(1,722150);
kr_chi2_2015_list=zeros(1,722150);
electron_lifetime_2016_list=zeros(1,722150);
electron_lifetime_2015_list=zeros(1,722150);
kr_staterr_2016_list=zeros(1,722150);
kr_staterr_2015_list=zeros(1,722150);
kr_sigma_2016_list=zeros(1,722150);
kr_sigma_2015_list=zeros(1,722150);
kr_2016_num_events=zeros(1,722150);
kr_2015_num_events=zeros(1,722150);
kr_means_2016_list=zeros(1,722150);
kr_means_2015_list=zeros(1,722150);
full_kr_chi2_2016_list=zeros(1,722150);
full_kr_chi2_2015_list=zeros(1,722150);
total_h3_chi2_nothresh_list=zeros(1,722150);
total_chi2_nothresh_list=zeros(1,722150);
alternate_total_chi2_nothresh_list=zeros(1,722150);
h3_chi2_2016_nothresh_list=zeros(1,722150);
h3_chi2_2015_nothresh_list=zeros(1,722150);
h3_chi2_2015_nothresh_separatescaling_list=zeros(1,722150);
h3_chi2_2016_nothresh_separatescaling_list=zeros(1,722150);

total_h3_chi2_nothresh_separatescaling_list=zeros(1,722150);
total_chi2_nothresh_separatescaling_list=zeros(1,722150);

h3_chi2_2016_oldsim_list=zeros(1,722150);
h3_chi2_2015_oldsim_list=zeros(1,722150);
total_h3_chi2_oldsim_list=zeros(1,722150);
total_chi2_oldsim_list=zeros(1,722150);


ee_list=zeros(1,722150);

kr_chi2_2016_zslice_list=zeros(722150,length(40+20/2:20:300-20/2));
kr_chi2_2015_zslice_list=zeros(722150,length(40+20/2:20:300-20/2));
kr_chi2_zslice_zcenter_list=zeros(722150,length(40+20/2:20:300-20/2));
%         
...
load('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\KrypCal_RD\KrypCal_2p21\NEST_CH3T_Spectrum_Sep2015_Kr2p21.mat')
load('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\KrypCal_RD\KrypCal_2p21\NEST_CH3T_Spectrum_Feb2016_Kr2p21.mat')
load('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\KrypCal_RD\KrypCal_2p21\NEST_CH3T_Spectrum_old.mat')


a2_counter=1;
for a2=0:0.005:0.12; %p1*x^2 coefficient for s1ab_s2_xyz_fit.p1
    b2_counter=1;
    for b2=0:0.01:0.25; %p1*x^2 coefficient for s1ab_s2_xyz_fit.p1
...
g1_counter=1;
for g1=0.095:0.001:0.105;
  g2_counter=1;
%     for g2=16.5:0.1:21;
      for ee=0.7:0.002:0.9;
...
save('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\KrypCal_RD\KrypCal_2p21\TritiumMethod\libNEST_CH3TModel\S1aS1bParamScan_EnergyChi2_S1FloatPoly_S2Poly2015_ImprovedFineRes.mat') 
