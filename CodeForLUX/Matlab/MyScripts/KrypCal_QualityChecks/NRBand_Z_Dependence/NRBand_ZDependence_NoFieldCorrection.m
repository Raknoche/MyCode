...
%USES X_CM_TMPLT SICNE THE MERCURY POSITION RQS ARE MESSED UP IN THIS KR DATA SET
% path='C:\Users\Richard\Desktop\LUX Analysis\MultiZDD_KrData\lux10_20140915T1138_cp13945'; %For 3D
...
%  
 ...
 %Adding upper and lower band sections
  color_counter=1;
 for i=[1:1:5];
 % Upper band
 tempx=NR_bins_tracked{i};
 tempy=NR_upper_fit_points{i};
 tempy_err=NR_upper_fit_points_err{i};
...
% lower band
 tempx=NR_bins_tracked{i};
 tempy=NR_lower_fit_points{i};
 tempy_err=NR_lower_fit_points_err{i};
