...
path='C:\Users\Richard\Desktop\LUX Analysis\lux10_20141104T1748_cp18524';
...
k
  ...
  %Save ER Band fits
  save('Nov2014_S1aS1b','s1ab_xyz_mean','s1ab_xyz_xbins','s1ab_xyz_ybins','s1ab_xyz_zbins','s1ab_P','s1ab_z_means','s1ab_bincenters','Kr_count_3D','Kr_count_1D');

else
   %Save ER Band fits
  save('Nov2014_S1aS1b','s1ab_P','s1ab_z_means','s1ab_bincenters','Kr_count_1D');
